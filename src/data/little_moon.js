...
const little_moon = {
  ...
  light: {
    ...
    level: {
      ...
      err_br: selenized.light.red_1,
      err_bg: selenized.light.bg_red,
      warn: selenized.light.yellow,
      warn_br: selenized.light.yellow_1,
      warn_bg: selenized.light.bg_yellow,
      info: selenized.light.blue,
      info_br: selenized.light.blue_1,
      info_bg: selenized.light.bg_blue,
      hint: selenized.light.cyan,
      hint_br: selenized.light.cyan_1,
